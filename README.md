...
description: Using Azure OpenAI agent with Python, integrating Bing Grounding in Azure AI Agent Service and Azure AI Search, to create articles based on user topics and instruction.
---
